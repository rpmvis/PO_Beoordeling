<%@ Page language="c#" Codebehind="tTL_Afde_Peri.aspx.cs" AutoEventWireup="false" Inherits="PO_Beoordeling.tTL_Afde_Peri" %>
<HTML>
	<HEAD>
	...
	<body class="body" onload="init();">
		<form id="tTL_Afde_Peri" method="post" runat="server">
			...
			<div id="content_beheerder_leftalign"><asp:dropdownlist id="ddlSelPeri" runat="server" Width="100px"></asp:dropdownlist>&nbsp;&nbsp;
				...
				<asp:button id="btnSelect" runat="server" Width="93px" Text="Selecteer"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
				<br>
				<asp:datagrid id="_grid" runat="server" CssClass="dg" ShowFooter="True" CellPadding="1" BorderWidth="1px" BorderColor="#AEC2DD" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" Width="789px">
					...
					<Columns>
						...
						<ASP:TemplateColumn SortExpression="TLNaam" HeaderText="TLNaam">
							<ItemTemplate>
								<ASP:Label id="Label1" runat="server" Enabled =False Width="100%" Visible="True" Text='<%# DataBinder.Eval(Container.DataItem, "TLNaam") %>' /></ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
						...
						<ASP:TemplateColumn HeaderText="Afdeling" SortExpression="Afde" ItemStyle-Wrap="True">
							<ItemTemplate>
								...
								<ASP:DropDownList id=ddl_Afde CssClass = "dg" runat="server" Width="350px" Enabled="False" DataValueField="Afde" DataTextField="Afde_Omschr" DataSource="<%# Bind_ddlAfde() %>" />
							</ItemTemplate>
							<FooterTemplate>
