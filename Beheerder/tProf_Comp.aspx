<%@ Page language="c#" Codebehind="tProf_Comp.aspx.cs" AutoEventWireup="false" Inherits="PO_Beoordeling.tProf_Comps" %>
<HTML>
	<HEAD>
		<title>tProf_Comp</title>
	...
	<body class="body" onload="init();">
		<form id="tProf_Comp" method="post" runat="server">
			<div id="top_leftalign">
				<table>
					...
					<tr>
						<td class="titelbalk" colSpan="2">Tabel tProf_Comp</td>
					</tr>
				</table>
			</div>
			<div id="content_beheerder_leftalign"><asp:dropdownlist id="ddlSelGridItem" runat="server" Width="300px" AutoPostBack="True"></asp:dropdownlist>&nbsp;&nbsp;<br>
				...
				<asp:datagrid id="_grid" runat="server" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" BorderColor="#AEC2DD" BorderWidth="1px" CellPadding="1" ShowFooter="True" CssClass="dg">
					...
					<Columns>
						...
						<ASP:TemplateColumn HeaderText='' HeaderStyle-Width="0" SortExpression='Prof_CompId'>
							<ItemTemplate>
								<ASP:Label id=lblProf_CompId Visible =False Enabled=True runat='server' Text='<%# DataBinder.Eval(Container.DataItem, "Prof_CompId") %>' />
								</ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
								<ASP:TextBox id='_insProf_CompId' runat='server' Visible='False' Width="0" />
							</FooterTemplate>
							<EditItemTemplate>
								<ASP:TextBox id='_edtProf_CompId' runat='server' Width=0 Text='<%# DataBinder.Eval(Container.DataItem, "Prof_CompId") %>' />
							</EditItemTemplate>
						</ASP:TemplateColumn>
						<ASP:TemplateColumn HeaderText='Prof' SortExpression='Prof'>
							<ItemTemplate>
								<ASP:Label id=lblProf Visible =True Enabled=True runat='server' Text='<%# DataBinder.Eval(Container.DataItem, "Prof") %>' />
								</ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
							...
							<EditItemTemplate>
								<ASP:TextBox id='_edtProf' runat='server' Width='100%' Text='<%# DataBinder.Eval(Container.DataItem, "Prof") %>' />
							</EditItemTemplate>
						</ASP:TemplateColumn>
