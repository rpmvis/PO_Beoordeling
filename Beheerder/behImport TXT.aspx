<%@ Page language="c#" AutoEventWireUp="false" Codebehind="behImport TXT.aspx.cs" Inherits="PO_Beoordeling.behImport_TXT" %>
<HTML>
	<HEAD>
	...
	<body class="body" onload="init();">
		<div id="top_leftalign">
			<table>
				...
				<tr>
					<td class="titelbalk" colSpan="2">Import vanuit tekst bestand</td>
				</tr>
			</table>
		</div>
						...
						<form id="Form1" method="post" encType="multipart/form-data" runat="server">
							<TABLE height="121" cellSpacing="0" cellPadding="0" width="755" border="0" ms_2d_layout="TRUE">
								...
								<TR vAlign="top">
									...
									<TD style="HEIGHT: 52px"><asp:label id="lblFile" runat="server" Font-Bold="True">Tekst bestand (*.txt tab gescheiden)</asp:label></TD>
									<TD style="HEIGHT: 52px" colSpan="2"><input id="inpFile" style="WIDTH: 625px; HEIGHT: 22px" type="file" size="85" runat="server"></TD>
								</TR>
								<TR vAlign="top">
								...
								<TR vAlign="top">
									<TD colSpan="3" height="25"></TD>
									<TD><asp:label id="lbStatus" runat="server" Width="110px" Height="16px" Visible="False" ForeColor="Green">Importeren ...</asp:label></TD>
								</TR>
							</TABLE>
						</form>
					</TD>
