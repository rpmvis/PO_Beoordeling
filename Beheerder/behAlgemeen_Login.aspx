<%@ Page language="c#" Codebehind="behAlgemeen_Login.aspx.cs" AutoEventWireup="false" Inherits="PO_Beoordeling.behLogin" %>
		...
		<form method="post" runat='server'>
			<div id="top_leftalign">
				<table>
					...
					<tr height="100%">
						<td width="100%"><% Response.Write(Write_Menu_horizontaal_hist());%></td>
						<td>
							<img id="printbutton" class="NoPrint" onclick="PrintIt();" src='../Pics/buttons/print.gif' alt='Print vriendelijke versie'>
						</td>
					</tr>
					<tr>
						<td class="titelbalk" colspan="2">Inloggen beheerder</td>
					</tr>
				</table>
			</div>
			<div id="content_beheerder_leftalign">
				<table class="DROTable" id="tblLogin" style="VISIBILITY: hidden; HEIGHT: 180px">
					<TR>
						<td colSpan="2"><span class="MFkopbreedWit">Inloggen beheerder</span>
						</td>
					<tr>
						<td class="TD" style="WIDTH: 84px" vAlign="center">Beheerdersnaam</td>
					...
					<tr>
						...
						<td class="TD2"><INPUT id="btnLogin" style="WIDTH: 78px; HEIGHT: 24px" onclick="GoTo('Beheerder/behMenu.aspx');" type="button" value="Log in">
