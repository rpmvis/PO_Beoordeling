<%@ Page language="c#" Codebehind="tElem.aspx.cs" AutoEventWireup="false" Inherits="PO_Beoordeling.tElem" %>
<HTML>
	<HEAD>
		<title>tElem</title>
	...
	<body class="body" onload="init();">
		<form id="tElem" method="post" runat="server">
			<div id="top_leftalign">
				<table>
					...
					<tr>
						<td class="titelbalk" colSpan="2">Tabel tElem</td>
					</tr>
				</table>
			</div>
			<div id="content_beheerder_leftalign"><asp:dropdownlist id="ddlSelGridItem" runat="server" Width="300px" AutoPostBack="True"></asp:dropdownlist>&nbsp;&nbsp;<br>
				...
				<asp:datagrid id="_grid" runat="server" AutoGenerateColumns="False" AllowSorting="True" AllowPaging="True" BorderColor="#AEC2DD" BorderWidth="1px" CellPadding="1" ShowFooter="True" CssClass="dg">
					...
					<Columns>
						...
						<ASP:TemplateColumn HeaderText='Elem' SortExpression='Elem'>
							<ItemTemplate>
								<ASP:Label id=lblElem Visible =True Enabled =False runat='server' Text='<%# DataBinder.Eval(Container.DataItem, "Elem") %>' />
								</ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
							...
							<EditItemTemplate>
								<ASP:TextBox id='_edtElem' Enabled =False runat='server' Width='100%' Text='<%# DataBinder.Eval(Container.DataItem, "Elem") %>' />
							</EditItemTemplate>
						</ASP:TemplateColumn>
						<ASP:TemplateColumn HeaderText='ElemDescr' SortExpression='ElemDescr'>
							<ItemTemplate>
								<ASP:Label id=lblElemDescr Visible =True Enabled=True runat='server' Text='<%# DataBinder.Eval(Container.DataItem, "ElemDescr") %>' />
								</ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
								<ASP:TextBox id='_insElemDescr' runat='server' Visible='False' Width='100%' />
							</FooterTemplate>
							<EditItemTemplate>
								<ASP:TextBox id='_edtElemDescr' runat='server' Width='100%' Text='<%# DataBinder.Eval(Container.DataItem, "ElemDescr") %>' />
							</EditItemTemplate>
						</ASP:TemplateColumn>
						<ASP:TemplateColumn HeaderText='ElemDescr_break' SortExpression='ElemDescr_break'>
							<ItemTemplate>
								<ASP:Label id=lblElemDescr_break Visible =True Enabled=True runat='server' Text='<%# DataBinder.Eval(Container.DataItem, "ElemDescr_break") %>' />
								</ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
								<ASP:TextBox id='_insElemDescr_break' runat='server' Visible='False' Width='100%' />
							</FooterTemplate>
							<EditItemTemplate>
								<ASP:TextBox id='_edtElemDescr_break' runat='server' Width='100%' Text='<%# DataBinder.Eval(Container.DataItem, "ElemDescr_break") %>' />
							</EditItemTemplate>
						</ASP:TemplateColumn>
						<ASP:TemplateColumn HeaderText='Comp' SortExpression='Comp'>
							<ItemTemplate>
								<ASP:Label id=lblComp Visible =True Enabled=True runat='server' Text='<%# DataBinder.Eval(Container.DataItem, "Comp") %>' />
								</ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
							...
							<EditItemTemplate>
								<ASP:TextBox id='_edtComp' runat='server' Width='100%' Text='<%# DataBinder.Eval(Container.DataItem, "Comp") %>' />
							</EditItemTemplate>
						</ASP:TemplateColumn>
						<ASP:TemplateColumn HeaderText='Indi' SortExpression='Indi'>
							<ItemTemplate>
								<ASP:Label id=lblIndi Visible =True Enabled=True runat='server' Text='<%# DataBinder.Eval(Container.DataItem, "Indi") %>' />
								</ASP:Label>
							</ItemTemplate>
							<FooterTemplate>
								<ASP:TextBox id='_insIndi' runat='server' Visible='False' Width='100%' />
							</FooterTemplate>
							<EditItemTemplate>
								<ASP:TextBox id='_edtIndi' runat='server' Width='100%' Text='<%# DataBinder.Eval(Container.DataItem, "Indi") %>' />
							</EditItemTemplate>
						</ASP:TemplateColumn>
